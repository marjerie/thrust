...
template<typename T>
  class vector_base<T, thrust::virtual_allocator<T>>
{
  private:
    typedef thrust::detail::vm_storage<T,thrust::virtual_allocator<T>> storage_type;
  ...
  public:
     ...
     *  \param alloc The allocator to use by this vector_base.
     */
    explicit vector_base(const thrust::virtual_allocator<T> &alloc);
     ...
     *  \param alloc The allocator to use by this vector_base.
     */
    explicit vector_base(size_type n, const thrust::virtual_allocator<T> &alloc);
     ...
     *  \param alloc The allocator to use by this vector_base.
     */
    explicit vector_base(size_type n, const value_type &value, const thrust::virtual_allocator<T> &alloc);
     ...
     */
    template<typename InputIterator>
    vector_base(InputIterator first, InputIterator last, const thrust::virtual_allocator<T> &alloc);
